...
const babelOptions = (preset) => {
    const options = {
        ...
        // presets: ["@babel/preset-env"], //For js only
...
module.exports = {
    ...
    resolve: {
        extensions: [".js", ".json", ".png", ".jsx", ".ts", ".tsx"], //impoting files without explicitly declared extensions
        alias: {
    ...
    module: {
        rules: [
            ...
            {
                test: /\.(js|ts|jsx|tsx)$/, //Babel for js,ts,tsx,jsx
